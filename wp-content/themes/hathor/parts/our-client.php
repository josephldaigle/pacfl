 <div class="clients">
        <div class="title">
          <h2 class="green1"><a href="<?php echo get_permalink( get_page_by_title( 'Sponsors' ) ); ?>"><?php echo of_get_option('our_client'); ?></a></h2>
			<a id="see-more-sponsors" href="<?php echo get_permalink( get_page_by_title( 'Sponsors' ) ); ?>">See All</a>
		</div>
